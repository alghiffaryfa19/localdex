...
class PairingInputService : Service() {
    ...
    private fun submitCode(code: String, port: Int) {
        ...
        // The attempt is time-boxed by Adb.pair, so the idle timer would only
        ...
        pairingJob = serviceScope.launch {
            ...
            Adb.pair(this@PairingInputService, code, effectivePort)
                .onSuccess {
                    Prefs.setHasPairedBefore(this@PairingInputService)
                    showResultNotification(
                        title = "Pairing successful",
                        text = "Tap to return to LocalDex",
    ...
    companion object {
        ...
        const val ACTION_PAIRING_INPUT = "com.localdex.PAIRING_INPUT"
        const val ACTION_PAIRING_CANCEL = "com.localdex.PAIRING_CANCEL"
        const val ACTION_SUBMIT_CODE = "com.localdex.SUBMIT_PAIRING_CODE"
